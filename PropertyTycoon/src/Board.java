...
public class Board {
     ...
     public void populateBoard() throws IOException{
         board[0] = new BoardLocation(0,"Go",0, new int[]{0,0,0,0,0,0}, "", "landGO", false);
         board[1] = new BoardLocation(1,"Crapper Street",60, new int[]{2,10,30,90,160,250}, "brown", "", true);
         board[2] = new BoardLocation(2,"Pot Luck",0, new int[]{0,0,0,0,0,0}, "","doPLCard", false);
         board[3] = new BoardLocation(3,"Gangsters Paradise", 60, new int[]{4,20,60,180,320,450}, "brown","", true);
         board[4] = new BoardLocation(4,"Income Tax", 0, new int[]{0,0,0,0,0,0},"","taxIncome", false);
         board[5] = new BoardLocation(5,"Brighton Station", 200, new int[]{25,50,100,200,200,200},"station","station", true);
         board[6] = new BoardLocation(6,"Weeping Angel", 100, new int[]{6, 30, 90, 270, 400, 550},"blue","", true);
         board[7] = new BoardLocation(7,"Opportunity Knocks", 0, new int[]{0,0,0,0,0,0},"","doOKCard", false);
         ...
         board[15] = new BoardLocation(15,"Hove Station", 200, new int[]{25,50,100,200,200,200},"station","station", true);
         board[16] = new BoardLocation(16,"Cooper Drive", 180, new int[]{14, 70, 200, 550, 750, 950},"orange","", true);
         board[17] = new BoardLocation(17,"Pot Luck", 0, new int[]{0,0,0,0,0,0},"","doPLCard", false);
         ...
         board[22] = new BoardLocation(22,"Opportunity Knocks", 0, new int[]{0,0,0,0,0,0},"","doOKCard", false);
         ...
         board[25] = new BoardLocation(25,"Falmer Station", 200, new int[]{25,50,100,200,200,200},"station","station", true);
         ...
         board[33] = new BoardLocation(33,"Pot Luck",0, new int[]{0,0,0,0,0,0},"","doPLCard", false);
         board[34] = new BoardLocation(34,"Ibis Close", 320, new int[]{28, 150, 450, 1000, 1200, 1400},"green","", true);
         board[35] = new BoardLocation(35,"Lewes Station", 200, new int[]{25,50,100,200,200,200},"station","station", true);
         board[36] = new BoardLocation(36,"Opportunity Knocks", 0, new int[]{0,0,0,0,0,0},"","doOKCard", false);
         board[37] = new BoardLocation(37,"Hawking Way", 350, new int[]{35, 175, 500, 1100, 1300, 1500},"deep blue","", true);
         board[38] = new BoardLocation(38,"Super Tax", 0, new int[]{0,0,0,0,0,0},"","taxSuper", false);
